...
export default function Home() {
  ...
  return (
    <>
      <HeaderHomepage />
      <div className="flex flex-col items-center justify-center mt-6 md:mt-28 mx-8 bg-gray-100 p-4">
        <div className="flex items-center space-x-4 mb-8">
          ...
          <h2 className="font-bold text-2xl text-gray-900 inline-flex leading-none">ReTrove Market</h2>
        </div>

        <div className="w-full max-w-xl text-center">
          <p className="text-lg text-gray-700 mb-6">Welcome to ReTrove Market, a place where you can list new or used items for others to buy and reuse.</p>
          <p className="text-lg text-gray-700 mb-6">To access the shop, please register or sign in if you already have an account!</p>
        </div>

        {isAuthenticated && (
          <a href="/shop">
            <button className="bg-indigo-600 hover:bg-indigo-800 text-white font-bold rounded-full py-2 mx-5 px-4 my-2">Go to Shop</button>
          </a>
        )}
      </div>
    </>
