    ...
    <>
        ...
        <div className="bg-white p-8 rounded-md shadow-lg w-full max-w-lg">
                ...
                {photos.length === 1 ? (
                    ...
                    <img
                        src={`http://localhost:8080/photos/display/${photos[0].photoId}`}
                        alt="Preview"
                    ...
                    <Slider className="w-full px-10">
                        ...
                        <div key={index} className="relative">
                            <img
                            src={`http://localhost:8080/photos/display/${photo.photoId}`}
                            alt={`Photo ${index}`}
                            ...
                            onClick={(e) => handlePhotoDelete(e, photo.photoId)}
                            >
