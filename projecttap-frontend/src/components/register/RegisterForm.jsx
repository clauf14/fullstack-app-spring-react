...
import { request, setAuthenticationToken } from '../../app/axios_helper';
        ...
        <>
          ...
          <ChangeTheme/>
            ...
            <div className="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <input
                      ...
                      type="text"
                      required
                      placeholder="Enter your desider username" value={username} onChange={(e) => setUsername(e.target.value)}
                      className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    />
                  </div>
                </div>
              ...
              <p className="text-center text-gray-500 text-xs dark:text-slate-300">
            &copy;{currentDate.getFullYear()} ClauF Development. All rights reserved.
            </p>
            </div>
          </div>
        </>
