...
import ChangeTheme from "../login/ChangeTheme"
import { request, setAuthenticationToken, removeAuthenticationToken } from "../../app/axios_helper"
...
export default function Form() {
  ...
  const handleSubmit = (e) => {
    ...
    request("POST", "/register", { firstName: firstName, lastName: lastName, email: email, username: username, login: username, password: password, phoneNumber: phoneNumber })
      .then((response) => {
      ...
      <div className="dark:bg-slate-800 flex flex-col justify-center px-6 py-6 lg:px-8">
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              <title></title>
              <path d="M28.908,12.571a.952.952,0,0,0-.1-.166,3.146,3.146,0,0,0-.118-.423c-.006-.016-.012-.032-.02-.048L25.917,5.6A1,1,0,0,0,25,5H7a1,1,0,0,0-.917.6l-2.77,6.381a2.841,2.841,0,0,0,0,2.083A4.75,4.75,0,0,0,6,16.609V27a1,1,0,0,0,1,1H25a1,1,0,0,0,1-1V16.609a4.749,4.749,0,0,0,2.687-2.543,2.614,2.614,0,0,0,.163-.655A1.057,1.057,0,0,0,28.908,12.571ZM13,26V20h2v6Zm4,0V20h2v6Zm7,0H21V19a1,1,0,0,0-1-1H12a1,1,0,0,0-1,1v7H8V17a5.2,5.2,0,0,0,4-1.8,5.339,5.339,0,0,0,8,0A5.2,5.2,0,0,0,24,17Zm2.837-12.7A3.015,3.015,0,0,1,24,15a2.788,2.788,0,0,1-3-2.5,1,1,0,0,0-2,0A2.788,2.788,0,0,1,16,15a2.788,2.788,0,0,1-3-2.5,1,1,0,0,0-2,0A2.788,2.788,0,0,1,8,15a3.016,3.016,0,0,1-2.838-1.7.836.836,0,0,1,0-.571L7.656,7H24.344l2.477,5.7A.858.858,0,0,1,26.837,13.3Z"></path>
            </g>
          </svg>
          <h2 className="mt-5 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900 dark:text-slate-200">Create your account</h2>
        </div>
        ...
        <div className="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  type="text"
                  required
                  placeholder="Enter your desider username"
                  value={username}
            ...
            <div>
              ...
              <div className="mt-2">
                <div className="relative w-full">
                  ...
                  />
                  {/* Eye Icon Button */}
                  <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute inset-y-0 right-2 flex items-center text-indigo-600 hover:text-indigo-900">
          ...
          <div className="mt-4 flex items-center justify-center">
            <a className={message.includes("meet") || message.includes("exists") ? "text-red-500 font-semibold" : "text-green-500 hover:underline font-semibold"} href="/login">
              {message}
            </a>
          </div>
          ...
          <p className="text-center text-gray-500 text-xs dark:text-slate-300">&copy;{currentDate.getFullYear()} ClauF Development. All rights reserved.</p>
        </div>
      </div>
    </>
  )
