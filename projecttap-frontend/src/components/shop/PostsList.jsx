                    ...
                    <>
                        ...
                        <div className="relative overflow-x-auto flex flex-wrap justify-center bg-gray-100 py-5">
                            {filteredPosts.length === 0 ? (
                                <div className="text-center text-2xl mt-10 font-semibold text-gray-700">
                                    No products found
                                </div>
                            ) : (
                                filteredPosts.map((post, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="px-6 py-4">
                                            ...
                                            <p className="bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700">
                                                {post.status}
                                            </p>
                                        </div>
