...
export default function Header() {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 w-full z-10 bg-indigo-600 p-6 shadow-md transition-transform duration-300
          ${isVisible ? "translate-y-0" : "-translate-y-full"}
          sm:block md:block lg:relative`}
      >
        <div className="w-full flex items-center justify-between text-white">
          <a href="/shop" className="flex items-center flex-shrink-0">
            ...
            <span className="font-semibold hidden sm:block text-xl tracking-tight">ReTrove Market</span>
          </a>
                ...
                <a href={`/users/${loginInfo.id}`}>
                  <button className="text-sm px-4 py-2 leading-none border rounded text-white border-white hover:bg-white hover:border-indigo-600 hover:text-indigo-600">
                    <span className="flex items-center justify-center">
                      ...
                      <span className="hidden md:block ml-2">My profile</span>
                    </span>
                  </button>
                </a>
                ...
                <a href="/shop/add">
                  <button className="text-sm px-4 py-2 leading-none border rounded text-white border-white hover:bg-white hover:border-indigo-600 hover:text-indigo-600">
                    <span className="flex items-center justify-center">
                      ...
                      <span className="hidden md:block ml-2">Add product</span>
                    </span>
                  </button>
                </a>
              </>
      ...
      <div className="pt-28 sm:pt-28 md:pt-28 lg:pt-2"></div>
    </>
  )
}
