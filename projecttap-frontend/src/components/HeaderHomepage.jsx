...
export default function HeaderHomepage(){
    return (
        <>
          <nav className="flex flex-wrap items-center justify-between bg-indigo-600 p-6">
            <div className="w-full md:w-auto flex flex-col md:flex-row items-center md:justify-start text-white">
              <a href="/" className="flex flex-col items-center md:flex-row md:items-center flex-shrink-0 md:ml-20">
                ...
                <span className="font-semibold text-xl tracking-tight mt-2 md:mt-0 md:ml-3">ReTrove Market</span>
              </a>
            </div>
      
            <div className="w-full md:w-auto flex flex-col md:flex-row items-center mt-4 md:mt-0 md:mr-20">
              <a href="/login">
                <button className="w-full md:w-auto text-sm px-4 py-2 leading-none border rounded text-white border-white hover:bg-white hover:border-indigo-600 hover:text-indigo-600 mb-4 md:mb-0 md:mr-6">
                  <span className="flex items-center justify-center">
                    <MdLogin style={{ fontSize: '1.5em', marginRight: '7px' }} />
                    Login
                  </span>
                </button>
              </a>
              <a href="/register">
                <button className="w-full md:w-auto text-sm px-4 py-2 leading-none border rounded text-white border-white hover:bg-white hover:border-indigo-600 hover:text-indigo-600">
                  <span className="flex items-center justify-center">
                    <IoCreateOutline style={{ fontSize: '1.5em', marginRight: '7px' }} />
                    Register
                  </span>
                </button>
              </a>
